...
with row1[1]:
    number_of_dependants = st.number_input("number_of_dependants", min_value = 0, step = 1, max_value = 5)
with row1[2]:
    region = st.selectbox("region",  categorical_options["region"])    
     

with row2[0]:
    income_lakhs = st.number_input("income_in_lakhs", min_value=0, step = 1, max_value=100)
with row2[1]:
...
with row3[0]:
    genetical_risk = st.number_input("genetical_risk", min_value=0, step = 1, max_value=20)
with row3[1]:
